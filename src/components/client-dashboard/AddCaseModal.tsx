            ...
            <div className="space-y-2.5">
              ...
              <div className="grid grid-cols-2 gap-2">
                ...
                <div
                  ...
                  className={`group flex items-center justify-between px-3 py-2 rounded-lg border-2 transition-all cursor-pointer ${
                    mriFile 
                ...
                <div
                  ...
                  className={`group flex items-center justify-between px-3 py-2 rounded-lg border-2 transition-all ${
                    !mriFile 
            ...
            <div className="space-y-2.5 flex-1">
              ...
              <div className="space-y-2">
                ...
                <div className={`flex items-center justify-between px-3 py-2 rounded-lg border transition-all ${
                  docMedicalHistory ? "border-green-500/20 bg-green-50/30 text-green-700" : "border-slate-200/80 bg-white hover:bg-slate-50/30"
                }`}>
                  <div className="flex items-center gap-2 min-w-0 flex-1">
                ...
                {/* 2. Consent Form */}
                <div className={`flex items-center justify-between px-3 py-2 rounded-lg border transition-all ${
                  docConsent ? "border-green-500/20 bg-green-50/30 text-green-700" : "border-slate-200/80 bg-white hover:bg-slate-50/30"
                }`}>
                  <div className="flex items-center gap-2 min-w-0 flex-1">
                ...
                {/* 3. Case Report Form */}
                <div className={`flex items-center justify-between px-3 py-2 rounded-lg border transition-all ${
                  docCaseReport ? "border-green-500/20 bg-green-50/30 text-green-700" : "border-slate-200/80 bg-white hover:bg-slate-50/30"
                }`}>
                  <div className="flex items-center gap-2 min-w-0 flex-1">
                ...
                <div className={`flex items-center justify-between px-3 py-2 rounded-lg border transition-all ${
                  docPatientInfo ? "border-green-500/20 bg-green-50/30 text-green-700" : "border-slate-200/80 bg-white hover:bg-slate-50/30"
                }`}>
                  <div className="flex items-center gap-2 min-w-0 flex-1">
                ...
                {/* 5. Others */}
                <div className={`flex items-center justify-between px-3 py-2 rounded-lg border transition-all ${
                  docOthers ? "border-green-500/20 bg-green-50/30 text-green-700" : "border-slate-200/80 bg-white hover:bg-slate-50/30"
                }`}>
                  <div className="flex items-center gap-2 min-w-0 flex-1">
